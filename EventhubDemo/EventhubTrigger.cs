...
namespace EventhubDemo
{
    public static class EventhubTrigger
    {
        ...
        public static async Task Run([EventHubTrigger("oliverniklas", Connection = "AzureWebJobsEventHub", ConsumerGroup = "oliverconsumergroup"),] string myEventHubMessage, ILogger log)
        {
